...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of DZPopupMessageView."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/DZPopupMessageView"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "darkzero" => "darkzero_mk2@hotmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DZPopupMessageView.git", :tag => s.version.to_s }
